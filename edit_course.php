...
$sql = "SELECT * FROM courses WHERE courses_code='$course_code'";
...
echo "<tr><td>Course Code:</td><td><input type=text name=courses_code value=".$course["courses_code"]."
/></td></tr>";
echo "<tr><td>Course Name:</td><td><input type=text name=courses_name value='".$course["courses_name"]."'
/></td></tr>";
